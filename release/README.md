...
4. Launch **Nyaya-Uday** from your app drawer.
...
- **Tests:** 6/6 passing | `flutter analyze`: 0 issues
- **Features:** CVI chatbot (5 features), LLM-powered, 9 landmark cases, roadmap progress tracking, personal notes, TTS, editable profile, legal aid data, daily legal tip (30 bilingual), study streak tracker, legal glossary (43 EN / 30 HI terms), smart LLM response sizing
